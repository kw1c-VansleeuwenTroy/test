...
#define SBF_OFFSET_ANALOG_INPUTS_RD  16#302 //register of analog inputs, first Byte of data is a message counter
...
#define SBF_OFFSET_ANALOG_VALUE_TRIPLE_PUFFER_SWITCH_OFFSET_WR_1 16#300
#define SBF_OFFSET_ANALOG_VALUE_TRIPLE_PUFFER_SWITCH_OFFSET_WR_2 16#301
